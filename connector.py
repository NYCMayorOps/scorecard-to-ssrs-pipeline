...
class Connector:
    ...
    def __init__(self):
        ...
        self.fd_mock = self.ryan_filter(pd.read_csv('./scorecard_reporting/fd_mock_all.csv'))
        self.fd_bids_mock = self.ryan_filter(pd.read_csv('./scorecard_reporting/fd_bids.csv'))
